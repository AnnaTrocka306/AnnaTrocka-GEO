...
Ein **Knowledge Object** ist die kleinste eigenständige Wissenseinheit der Knowledge Architecture.

Es beschreibt genau einen Begriff und besitzt genau eine kanonische Definition.

Jedes Knowledge Object wird als eigenes Dokument verwaltet und ist Teil des **[Knowledge Dictionary](../Knowledge%20Dictionary/README.md)**.
```
