...
display_name_de: Dienstleistungsentität
filename: Service_Entity.md
...
repository_path: "docs/knowledge-base/Knowledge_Dictionary/Service_Entity.md"
...
# Dienstleistungsentität

## Definition

Eine **Service Entity** ist eine Spezialisierung einer [Semantic Entity](Semantic_Entity.md), die eine Dienstleistung innerhalb einer [Knowledge Architecture](Knowledge_Architecture.md) repräsentiert.

Sie dient als semantischer Bezugspunkt für dienstleistungsbezogenes Wissen und ermöglicht die eindeutige Zuordnung von Informationen, Eigenschaften und Beziehungen zu einer bestimmten Dienstleistung.

Die Regeln für die Modellierung, Strukturierung und Verknüpfung einer Service Entity mit anderen Semantic Entities werden im [Semantic Entity Standard](Semantic_Entity_Standard.md) definiert.
